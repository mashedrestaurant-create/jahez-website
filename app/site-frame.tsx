...
function FloatingSocial({ whatsappUrl }: { whatsappUrl: string | null }) {
  const links = SocialLinksData();
    ...
    <div className="floating-social">
      {whatsappUrl && (
        <a
          ...
          aria-label="WhatsApp"
          title="WhatsApp"
          className="floating-social-item whatsapp"
        >
  ...
  return (
    <footer className="site-footer jahez-footer">
      ...
      <FloatingSocial
        whatsappUrl={
          whatsappNumber
            ? `https://wa.me/${whatsappNumber}?text=${encodeURIComponent(isArabic ? "أهلاً چاهِز، عايزة أستفسر عن طلب" : "Hello Jahez, I would like to ask about an order")}`
            : null
        }
      />
    </footer>
